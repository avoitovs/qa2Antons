...
public class AssertionManager {
    ...
    protected void commentAmountAssertion (int [] arrayOfCommentsDesktop, int [] arrayOfCommentsMobile){
    ...
    protected void titleAssertion (List listOfTitlesDesktop, List listOfTitlesMobile) {
